# -*- coding: utf-8 -*-
"""
Created on Wed Dec  10 08:00:05 2021
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = "Jordi Martos", amount = 10)
...
def replace_chain():
    ...
    if is_chain_replace:
        response = {'message' : 'Los nodos tenian diferentes cadenas, que han sido  todas reemplazadas por la más larga.',
